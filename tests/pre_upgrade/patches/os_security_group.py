...
options:
   ...
   state:
     ...
     default: present
   egress_default_rules:
     version_added: "2.3"
     description:
       - Remove default egress security rules
     choices: [present, absent]
     default: present
'''
...
def main():
    argument_spec = openstack_full_argument_spec(
        ...
        egress_default_rules=dict(default='present',
    ...
    egress_default_rules = module.params['egress_default_rules']
    ...
    try:
        ...
        if state == 'present':
            if not secgroup:
                ...
                if egress_default_rules == 'absent':
